...
<div class="add-div">
	<form class="add-form" method="POST" action="add-movie.php">
		...
		<input type='file' name ='movie_image' placeholder="Film Image" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Film Image'">
		
		<br><br>


		<a href='add-movie.php'><input type='submit' name='add' id='addmvbtn' class='btn3' value='ADD MOVIE'></a><br><br><br>
		<a href='add-movie.php'><input type='button' name='reset' id='resetbtn' class='btn3' value='RESET'>
		</a>
	</form>
